...
class InstructionPage:
    ...
    def __init__(self):
        ...
        self.frequency_tool = ("This tool allows you to query the frequency of a specified n-grams in the free text, as well as"
            ...
            " free text with all words other than those appearing in a medical lexicon removed. The medical lexicon we use is from Aristotelis P., R. Robinson,"
        ...
        self.user_analysis = ("This tool allows analysis of a specific user, identified by their user ID. The tool can generate the free text entries of that user,"
        ...
        self.trend_analysis = ("This tool plots the trend of multiple users’ sentiment and disability scores overtime. A minimum of 20 users is required to use this tool."
